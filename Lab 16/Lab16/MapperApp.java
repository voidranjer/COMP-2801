...
public class MapperApp extends JFrame {
  ...
  public MapperApp(int widthInCentimeters, int heighInCentimeters) {
    ...
    JCheckBoxMenuItem highlightConvexObstaclesButton = new JCheckBoxMenuItem("Highlight Convex Obstacles");  planningMenu.add(highlightConvexObstaclesButton);
    ...
    highlightConvexObstaclesButton.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        PathPlanner.HighlightConvexObstacles = highlightConvexObstaclesButton.isSelected();
        PathPlanner.ShowObstacles = true;
        PathPlanner.ShowConvexObstacles = false;
        showObstaclesButton.setSelected(true);
        showConvexObstaclesButton.setSelected(false);
