...
public class PathPlanner {
  ...
  public void resetEndpoint() { end = originalEnd; }
  ...
  public boolean supportLineIntersectsObstacle(int x, int y, int supportX, int supportY, Obstacle fromObst, ArrayList<Obstacle> allObstacles) {
    for (Obstacle ob: allObstaclesvvvvvvvvvvvvvvvvvvvvvvvvv) {
  ...
  // This code runs Dijkstra's shortest path algorithm in the visibilty graph with a high cost on turns
