...
public class Lab18Controller {
  ...
  static final double MAX_SPEED = 1; // 19.1 is maximum but it seems that higher values can distort the sensor
                                     // readings
  ...
  public static void main(String[] args) {
    ...
    // Run the robot
    while (robot.step(TimeStep) != -1) {
      // Check to make sure that the path has been obtained. If so, start/continue
      // moving
