...
public class PathPlanner {
  ...
  // Update the visibility graph by rermoving all edges frrom the old end location
  // and adding ones to the new end location
  ...
  public ArrayList<Point> getShortestPath() {
    ...
    Node currNode = visibilityGraph.node(end.x, end.y);
    while (currNode != null) {
      stack.add(currNode.getLocation());
