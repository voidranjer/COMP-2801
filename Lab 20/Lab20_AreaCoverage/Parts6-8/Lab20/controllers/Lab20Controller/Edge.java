...
public class Edge {
  ...
  public void draw(Graphics aPen, int height, int magnification, int thickness) {
    ...
    aPen.drawLine(startNode.getLocation().x*magnification, height - startNode.getLocation().y*magnification,
                  endNode.getLocation().x*magnification, height - endNode.getLocation().y*magnification);
    ((Graphics2D)aPen).setStroke(new BasicStroke(1));
  }
