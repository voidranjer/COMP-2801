...
public class Node implements Comparable<Node> {
  ...
  public void draw(Graphics aPen, int height, int magnification) {
    ...
    aPen.fillOval((int)(location.x*magnification - radius), 
                  (int)(height - location.y*magnification - radius), 
                  radius * 2, radius * 2);

    // Draw a black border around the circle
    aPen.setColor(Color.black);
    aPen.drawOval((int)(location.x*magnification - radius), 
                  (int)(height - location.y*magnification - radius), 
                  radius * 2, radius * 2);

    // Draw a label at the top right corner of the node
    if (label != "")
      aPen.drawString(label, (int)(location.x*magnification + radius), 
                      (int)(height - location.y*magnification - radius));
  }
