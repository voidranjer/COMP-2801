...
public class Edge {
  ...
  public void draw(Graphics aPen, int height, int magnification, int thickness) {
    ...
    aPen.drawLine((int)(startNode.getLocation().x*magnification), 
                  (int)(height - startNode.getLocation().y*magnification),
                  (int)(endNode.getLocation().x*magnification), 
                  (int)(height - endNode.getLocation().y*magnification));
    ((Graphics2D)aPen).setStroke(new BasicStroke(1));
  }
