...
public class Lab21Controller {
  ...
  static final double  MAX_SPEED = 3;    // 19.1 is maximum but it seems that higher values can distort the sensor readings
  ...
  public static void main(String[] args) {
    ...
    MapperApp   mapper = new MapperApp(WORLD_WIDTH, WORLD_HEIGHT, robot.getDisplay("display")); // Make sure these dimensions match the environment.  
    ...
    ArrayList<java.awt.geom.Point2D.Double> path = null;
