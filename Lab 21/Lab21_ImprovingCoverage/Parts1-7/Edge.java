...
public class Edge {
  ...
  public void draw(Graphics aPen, int height, int magnification, int thickness) {
    ...
    aPen.drawLine((int)(MapperApp.MARGIN_X/2 +startNode.getLocation().x*magnification), 
                  (int)(MapperApp.MARGIN_Y/2 + height - startNode.getLocation().y*magnification),
                  (int)(MapperApp.MARGIN_X/2 +endNode.getLocation().x*magnification), 
                  (int)(MapperApp.MARGIN_Y/2 + height - endNode.getLocation().y*magnification));
    ((Graphics2D)aPen).setStroke(new BasicStroke(1));
  }
