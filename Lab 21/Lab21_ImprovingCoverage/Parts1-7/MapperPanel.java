	...
	try {
      ...
      if (MapperApp.ShowPositions && (areaCoverage.getGridGraph() != null)) {
        for (Node n: areaCoverage.getGridGraph().getNodes()) {
          ...
          aPen.setColor(Color.black);
          aPen.drawOval((int)(MapperApp.MARGIN_X/2 + p.x*magnification - (int)(AreaCoverage.ROBOT_RADIUS*magnification)),  
                        (int)(MapperApp.MARGIN_Y/2 + vmap.getHeight() - p.y*magnification - (int)(AreaCoverage.ROBOT_RADIUS*magnification)), 
