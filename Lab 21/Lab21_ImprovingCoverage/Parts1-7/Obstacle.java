...
public class Obstacle {
  ...
  private ArrayList<java.awt.geom.Point2D.Double>   extendedVertices;    // The vertices extended out from the bisectors for area coverage
  ...
  public Obstacle() {
    ...
    extendedVertices = new ArrayList<java.awt.geom.Point2D.Double>();
    polygonWasComputed = false;
    original = this;
  }
  
  public ArrayList<Point> getVertices() { return vertices; }
  public ArrayList<java.awt.geom.Point2D.Double> getExtendedVertices() { return extendedVertices; }
  ...
  public void addExtendedVertex(java.awt.geom.Point2D.Double p) {
    extendedVertices.add(p);
  }
  
  public Point getVertex(int i) { return vertices.get(i); }
  public java.awt.geom.Point2D.Double getExtendedVertex(int i) { return extendedVertices.get(i); }
  ...
  public boolean pointOnBoundary(java.awt.geom.Point2D.Double p) {
